...
class _AdjointLinearOperator(LinearOperator):
    ...
    def __init__(self, A):
        ...
        super().__init__(dtype=A.dtype, shape=shape, device=A.device)
        self.A = A
        self.args = (A,)
...
class _ScaledLinearOperator(LinearOperator):
    def __init__(self, A, alpha):
        ...
        super().__init__(dtype, A.shape, device=A.device)
        self.args = (A, alpha)
...
class _PowerLinearOperator(LinearOperator):
    def __init__(self, A, p):
        ...
        super().__init__(_get_dtype([A]), A.shape, device=A.device)
        self.args = (A, p)
...
class IdentityOperator(LinearOperator):
    ...
    def to_gpu(self):
        return IdentityOperator(self.shape, dtype=self.dtype, device="gpu")
    
    def to_cpu(self):
        return IdentityOperator(self.shape, dtype=self.dtype, device="cpu")
...
def aslinearoperator(A):
    ...
    # ADD CONDITIONS FOR CUPY ARRAYS
